...
def get_cloud_config_for_default_user(is_default_user_sudo_access_enabled):
    """Return Cloud-Init Section ( cloud-config) in YAML format if DisableSudoAccessForDefaultUser is enabled."""
    return yaml.dump(DISABLE_SUDO_ACCESS_FOR_DEFAULT_USER_CONFIG) if is_default_user_sudo_access_enabled else ""
