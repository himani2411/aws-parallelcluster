...
mpirun --mca btl_tcp_if_exclude lo -n 192 -N 96 -x FI_EFA_USE_DEVICE_RDMA=1 /shared/openmpi/osu-micro-benchmarks-${OSU_BENCHMARK_VERSION}/mpi/pt2pt/${BENCHMARK_NAME} -d cuda D D> /shared/${BENCHMARK_NAME}.out
