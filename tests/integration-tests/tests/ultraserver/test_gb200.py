...
from utils import wait_for_computefleet_changed, get_compute_nodes_instance_ids, get_instance_info
...
CAPACITY_BLOCK_RESERVATION_ID = "cr-040b3507f83e9eb74"
...
def test_gb200(
    ...
    #want to Run Burst of NCCL Jobs
